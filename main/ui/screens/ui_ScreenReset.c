...
void ui_ScreenReset_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_ScreenReset, lv_color_black(), 0);
    ...
    lv_obj_set_style_text_font(ui_LabelResetTitle, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_LabelResetContent, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_LabelSetupBtn2, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
