...
void ui_ScreenSettings_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_ScreenSettings, lv_color_black(), 0);
    ...
    lv_obj_set_style_text_font(ui_LabelSettingsTile, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_LabelSettingsRegion, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
